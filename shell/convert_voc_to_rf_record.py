...
r"""Convert raw VOC data to TFRecord for object_detection.
...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '../data', 'Root directory to raw VOC data.')
...
def main(_):
  ...
  print("Handle complete!!!\nGenerate file "+FLAGS.output_path)
